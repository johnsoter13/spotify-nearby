...
export default function HomeScreen() {
  ...
  return (
    <View className="flex-1 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-white">
      <View className="px-6 pt-12 pb-6">
        <View className="flex-row items-center justify-between mb-6">
          ...
          <View className="w-12 h-12 rounded-full items-center justify-center bg-gradient-to-br from-pink-500 to-purple-600">
          </View>
        </View>
        {currentlyPlaying.isSharing && (
          <View className="bg-white/15 rounded-2xl p-4 mb-6 border border-white/20">
            <View className="flex-row items-center gap-3">
              <View className="w-10 h-10 bg-gradient-to-br from-green-400 to-blue-500 rounded-lg items-center justify-center">
              </View>
